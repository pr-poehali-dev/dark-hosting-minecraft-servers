      ...
      <main className="flex-1 pt-28 pb-16">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <h1 className="text-3xl md:text-4xl font-bold mb-4">Оплата прошла успешно!</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-12">
              <Button size="lg" className="bg-minecraft-accent hover:bg-minecraft-accent/80 py-6">
                <Icon name="Layout" className="mr-2" />
                Панель управления
              </Button>
              
              <Button size="lg" variant="outline" className="border-white/20 hover:bg-white/5 py-6">
            ...
            <div className="bg-minecraft-green/10 border border-minecraft-green/30 rounded-lg p-6">
              <h3 className="text-lg font-bold mb-2 flex items-center">
                <Icon name="Lightbulb" className="mr-2 text-minecraft-green" size={20} />
                Что дальше?
              </h3>
              <p className="text-white/70 mb-4">
                Воспользуйтесь нашими руководствами, чтобы настроить свой сервер и пригласить друзей
              </p>
              <div className="flex flex-wrap justify-center gap-4">
                <Link to="/guide" className="text-minecraft-accent hover:text-minecraft-accent/80 underline">
                  Руководство по настройке
                </Link>
                <Link to="/plugins" className="text-minecraft-accent hover:text-minecraft-accent/80 underline">
                  Популярные плагины
                </Link>
                <Link to="/faq" className="text-minecraft-accent hover:text-minecraft-accent/80 underline">
