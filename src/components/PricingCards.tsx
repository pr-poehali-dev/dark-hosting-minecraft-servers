      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-white/70 max-w-2xl mx-auto">
            Гибкие тарифы для любых потребностей с возможностью масштабирования
            по мере роста вашего сервера
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {pricingPlans.map((plan) => (
            <Card
              key={plan.name}
              className={`relative overflow-hidden hover-effect ${plan.popular ? "border-minecraft-accent ring-1 ring-minecraft-accent" : "bg-minecraft-gray/10 border-minecraft-gray/30"}`}
            >
              {plan.popular && (
              ...
              <CardHeader>
                <div
                  className={`w-12 h-12 rounded-lg flex items-center justify-center ${plan.popular ? "bg-minecraft-accent/20" : "bg-minecraft-gray/20"} mb-4`}
                >
